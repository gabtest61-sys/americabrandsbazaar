    ...
    <div className="fixed inset-0 z-[200] bg-navy flex flex-col items-center justify-center">
      ...
      <div className="relative mb-8">
        <div className="w-20 h-20 rounded-full bg-white shadow-2xl flex items-center justify-center animate-pulse">
          <span className="text-navy font-bold text-2xl">ABB</span>
        </div>
        {/* Spinning ring */}
      ...
      {/* Brand Name */}
      <h1 className="text-white text-xl font-bold tracking-wider mb-2">AMERICA BRANDS BAZAAR</h1>
      <p className="text-gold/80 text-sm tracking-[0.2em] uppercase mb-8">Discover Premium Brands</p>
